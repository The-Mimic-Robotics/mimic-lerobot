#!/bin/bash
# Pi0.5 Evaluation Script - Smart Configuration
...
: ${MODEL_PATH:?"Error: MODEL_PATH not set. Example: export MODEL_PATH=Mimic-Robotics/pi05_odin_all_datasets"}
: ${EVAL_DATASET:?"Error: EVAL_DATASET not set. Example: export EVAL_DATASET=Mimic-Robotics/eval_pi05_test"}
: ${NUM_EPISODES:=10}
...
echo "=========================================="
echo "Pi0.5 Evaluation Configuration"
echo "=========================================="
