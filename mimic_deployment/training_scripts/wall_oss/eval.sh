#!/bin/bash
# Diffusion Evaluation Script - Smart Configuration
...
: ${MODEL_PATH:?"Error: MODEL_PATH not set. Example: export MODEL_PATH=Mimic-Robotics/diffusion_odin_all_datasets"}
: ${EVAL_DATASET:?"Error: EVAL_DATASET not set. Example: export EVAL_DATASET=Mimic-Robotics/eval_diffusion_test"}
: ${NUM_EPISODES:=10}
...
echo "=========================================="
echo "Diffusion Evaluation Configuration"
echo "=========================================="
