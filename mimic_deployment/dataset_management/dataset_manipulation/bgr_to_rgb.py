...
def fix_bgr_to_rgb(src_repo_id: str, dst_repo_id: str, target_camera: str):
    ...
    dst_dataset = LeRobotDataset.create(
        ...
        image_writer_threads=6  #16 for the ryzen 9 
    )
...
if __name__ == "__main__":
    SOURCE_DATASET = "Mimic-Robotics/mimic_ttt_redBalanced_15hz"
    DESTINATION_DATASET = "Mimic-Robotics/mimic_ttt_redBalanced_15hz_rgb"
